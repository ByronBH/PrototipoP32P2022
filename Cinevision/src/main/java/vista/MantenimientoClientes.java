...
public class MantenimientoClientes extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeCombos() {
        ...
        List<clsClientes> empleados = daoclientes.select();
    ...
    public void llenadoDeTablas() {
        ...
        daoClientes daoclientes = new daoClientes();
        List<clsClientes> clientes = daoclientes.select();
        tablaVendedores.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < clientes.size(); i++) {
            dato[0] = Integer.toString(clientes.get(i).getId_clientes());
            dato[1] = clientes.get(i).getnombre();
            dato[2] = clientes.get(i).getnit();
    ...
    public void buscarVendedor() {
        clsClientes vendedorAConsultar = new clsClientes();
        daoClientes vendedorDAO = new daoClientes();
        vendedorAConsultar.setId_clientes(Integer.parseInt(txtbuscado.getText()));
        vendedorAConsultar = vendedorDAO.query(vendedorAConsultar);
        txtNombre.setText(vendedorAConsultar.getnombre());
        txtDireccion.setText(vendedorAConsultar.getnit());
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        daoClientes clsclientes = new daoClientes();
        clsClientes vendedorAEliminar = new clsClientes();
        vendedorAEliminar.setId_clientes(Integer.parseInt(txtbuscado.getText()));
        clsclientes.delete(vendedorAEliminar);
        llenadoDeTablas();
    }//GEN-LAST:event_btnEliminarActionPerformed

    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
       daoClientes vendedorDAO = new daoClientes();
        clsClientes vendedorAInsertar = new clsClientes();
        vendedorAInsertar.setnombre(txtNombre.getText());
        vendedorAInsertar.setnit(txtDireccion.getText());
...
//        // TODO add your handling code here:
        daoClientes vendedorDAO = new daoClientes();
        clsClientes vendedorAActualizar = new clsClientes();
        vendedorAActualizar.setId_clientes(Integer.parseInt(txtbuscado.getText()));
        vendedorAActualizar.setnombre(txtNombre.getText());
        vendedorAActualizar.setnit(txtDireccion.getText());
